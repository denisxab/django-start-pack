...
Вот пример замены стандартных шаблонов `Dajngo` на наши, будем использовать виртуального окружения `venv`, и `Linux`. (
...
- Файл с переменными окружениями называется  `__env.env`
